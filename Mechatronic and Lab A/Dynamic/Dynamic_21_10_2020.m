...
k=0.18083; % [N/mm] Look to 'k_spring.m' script % Try k=0.1235 (removing P1) or k=0.1538 (All values)
lx=249.67; % [mm] 
ly=284.8435; 
F_thrust=(k.*(lx.*sin(alpha2-gamma)+lx.*sin(gamma)).*lx.*cos(alpha2-gamma)+k.*(lx.*sin(alpha2+gamma)-lx.*sin(gamma)).*lx.*cos(alpha2+gamma))./ly;
