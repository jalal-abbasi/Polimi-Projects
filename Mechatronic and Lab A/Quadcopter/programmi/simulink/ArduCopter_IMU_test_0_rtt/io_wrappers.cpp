...
#if (defined(_RTT_TCPIP_EXTMODE) && (_RTT_TCPIP_EXTMODE == 1)) || (defined(_RTT_UDP_) && (_RTT_UDP_ != 0)) || (defined(_RTT_TCP_) && (_RTT_TCP_ != 0))
#include <Ethernet.h>
...
{
#if (defined(_ROTH_MEGA2560_) || defined(_ROTH_DUE_))
    switch(port) {
        case 0:
            Serial.begin(r);
            break;
...
{
    static int only_one_tcp_server_and_ethernet_begin;
